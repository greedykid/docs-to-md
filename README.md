...
├── PRD.md                # Product Requirements Document (Indonesian)
├── README.md             # Installation and setup documentation (This file)
├── index.html            # Main HTML structure and markup
├── style.css             # Custom stylesheet for dark/light themes, layouts, and workspace
├── app.js                # Main application logic, Mammoth/Turndown config, and resizer event listeners
├── vite.config.js        # Vite build configuration file
├── package.json          # Project metadata, dependencies, and npm scripts
├── package-lock.json     # Auto-generated lockfile for npm dependencies
├── sample.docx           # Standard sample Word document for conversion testing
├── sample_with_image.docx # Sample Word document containing images for testing assets extraction
└── sample_with_toc.docx   # Sample Word document with Table of Contents for testing smooth scroll sync
```
